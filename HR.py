...
class SalesGPT(Chain):
    ...
    company_business = "один из крупнейших универсальных банков России. Занимает третье место в списке банков Центральной и Восточной Европы по размеру собственного капитала. Головной офис расположен в Москве. Включён Центральным Банком РФ в перечень системно значимых кредитных организаций"

    course_location = "Предлагаемые тобой курсы проводятся дистанционно, через сайт компании. Если будут спрашивать про конкретный адрес компании, отвечай относительно данного здания, находящегося по адресу 117420, г. Москва, ул. Наметкина, дом 16, корпус 1."
